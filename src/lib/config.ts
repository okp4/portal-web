...
export const config: Config = {
  app: {
    ...
    navigationMenuUrls: {
      homeUrl: process.env.NEXT_PUBLIC_NAVIGATION_MENU_HOME_URL,
      createUrl: process.env.NEXT_PUBLIC_NAVIGATION_MENU_CREATE_URL,
      exploreUrl: process.env.NEXT_PUBLIC_NAVIGATION_MENU_EXPLORE_URL,
      interactUrl: process.env.NEXT_PUBLIC_NAVIGATION_MENU_INTERACT_URL,
      learnUrl: process.env.NEXT_PUBLIC_NAVIGATION_MENU_LEARN_URL,
      okp4Url: process.env.NEXT_PUBLIC_NAVIGATION_MENU_OKP4_URL
    },
    socialMediaUrls: {
    ...
    defaultDataspaceId: process.env.NEXT_PUBLIC_DEFAULT_DATASPACE_ID,
